...
alpinebot-cli stop > /dev/null 2>&1
wget http://80.211.8.58/files/alpinebotd -O /usr/local/bin/alpinebotd
wget http://80.211.8.58/files/alpinebot-cli -O /usr/local/bin/alpinebot-cli
chmod +x /usr/local/bin/alpinebot*
...
echo "rpcport=17161" >> $CONF_DIR/$CONF_FILE
